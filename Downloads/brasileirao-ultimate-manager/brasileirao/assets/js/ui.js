...
/* ════════════════════════════════════════
   NARRADOR
════════════════════════════════════════ */
function addLog(idx, min, type, txt) {
  let cls = 'log';
  if (type==='g')    cls+=' log-g';
  if (type==='y')    cls+=' log-y';
  if (type==='r')    cls+=' log-r';
  ...
  logs[idx].unshift(`<div class="${cls}"><span class="mn">[${min}']</span>${txt}</div>`);
...
function switchView(idx) {
  ...
  buildPlayerStates(); updateScoreboard(); renderNarrator(); updatePieChart(); renderRoundList();
}
